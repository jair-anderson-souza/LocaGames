...
public class DadosInvalidosException extends Exception {
    ...
    public DadosInvalidosException(Erro erro, String message, Throwable cause) {
        super(message, cause);
        this.erro = erro;
    }

    public DadosInvalidosException(Erro erro, Throwable cause) {
        this.erro = erro;
    }

    public DadosInvalidosException(Erro erro, String mensagem) {
        this.erro = erro;
    }

    public DadosInvalidosException(Exception e, String mensagem) {
        super(mensagem, e);
    }
